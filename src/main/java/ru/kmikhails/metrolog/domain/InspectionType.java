...
public class InspectionType implements Comparable<InspectionType> {
    private Long id;
    ...
    @Override
    public int compareTo(InspectionType o) {
        return inspectionType.compareTo(o.getInspectionType());
    }
}
